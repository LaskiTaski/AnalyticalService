...
from sqlalchemy import BigInteger, Date, DateTime, Float, ForeignKey, Index, Integer, String, func
...
class Bond(Base):
    ...
    # --- Issuer (риск-сигналы) ---
    issuer_inn: Mapped[str | None] = mapped_column(
        String(12),
        ForeignKey("issuers.inn", ondelete="SET NULL"),
        index=True,
